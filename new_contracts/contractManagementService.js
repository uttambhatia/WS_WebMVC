...
export const createContract = (payload, options = {}) =>
  http
    .post("/contract-management", payload, {
      params: {
...
export const uploadContractsExcel = (file) => {
  const formData = new FormData();
  formData.append("file", file);

  return http
    .post("/contract-management/upload-excel", formData, {
      headers: {
