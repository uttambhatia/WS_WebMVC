...
export default function ArrayLineEditor({ value, onChange, error, label, singleItem = false }) {
  ...
  return (
    <div className="fp__line-editor-wrap">
          ...
          <div className="fp__line-editor-row" key={`${label}-${index}`}>
            <div className="fp__line-editor-input-shell">
              <textarea
                ...
                placeholder={singleItem ? `Enter ${label.toLowerCase()}` : `Enter ${label.toLowerCase()} ${index + 1}`}
      ...
      {!singleItem && (
        <button
          type="button"
          className="fp__line-editor-btn fp__line-editor-btn--icon fp__line-editor-btn--add-icon"
          onClick={addItem}
        ...
        >
          ...
          <span className="fp__line-editor-add-text">Add</span>
        </button>
      )}
