...
/* ------------------------------------------------------------------ */
/*  T5.1 Get execution details by ID                                   */
...
/* ------------------------------------------------------------------ */
/*  T5.2 Get schedule details by ID                                    */
/*  GET /api/v1/schedules/{scheduleId}                                 */
/* ------------------------------------------------------------------ */
export const getScheduleDetails = (scheduleId) =>
  testExecHttp
    .get(`/api/v1/schedules/${scheduleId}`)
    .then((res) => res.data)
    .catch(() => null);
...
export const updateScheduleStatus = (scheduleId, payload) =>
  testExecHttp
    .post(`/api/v1/schedules/${scheduleId}/status`, payload)
    .then((res) => res.data);

/* ------------------------------------------------------------------ */
/*  T5.3 Timezone autocomplete                                         */
