    ...
    <div className={`db__stacked-chart ${shouldTiltLabels ? "db__stacked-chart--dense" : ""}`.trim()}>
      ...
      <div className="db__stacked-plot">
        ...
        <div className={`db__bars-area ${shouldTiltLabels ? "db__bars-area--dense" : ""}`.trim()}>
          ...
          <div
            className={`db__bars-row ${shouldTiltLabels ? "db__bars-row--dense" : ""}`.trim()}
            style={{ "--db-bar-count": bars.length }}
          >
            {bars.map((bar, index) => {
          ...
          <div
            className={`db__labels-row ${shouldTiltLabels ? "db__labels-row--dense" : ""}`.trim()}
            style={{ "--db-bar-count": bars.length }}
          >
            {bars.map((bar, index) => (
