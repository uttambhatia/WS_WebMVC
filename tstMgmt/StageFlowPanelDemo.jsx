...
const TestGenStageForm = forwardRef(function TestGenStageForm(props, ref) {
  return (
    <TestGenFormPanel
      ...
      squashConfig={{
        getFolderService: (folderId) => getSquashTestCaseFolder(folderId),
        createFolderService: ({ name, description, parentId }) =>
          createSquashTestCaseFolder({ name, description, parentId }),
        saveTestCasesService: (payload) => saveTestCasesToSquash(payload),
      }}
